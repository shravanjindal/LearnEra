...
const Pricing = () => {
  return (
    <section id="pricing" className="bg-gradient-to-r from-purple-500 via-indigo-500 to-blue-500 text-white py-20 px-6">
...
<p className="text-xl text-blue-200 mb-12">Flexible plans tailored to meet your needs.</p>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-10">
            <PricingCard plan='FREE' price='$0' target='Trail features' perks={["Generate general roadmaps", "Explore your interests","Test your skills", "Learn one skill","Email Support"]}/>
